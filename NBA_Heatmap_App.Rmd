...
server <- function(input, output, session) {
 ...
 HTML("<b>This app displays each player's attempted or made 3 pointers vs attempted or made 2 pointers by a full season that they were in the NBA.</b><div style='margin-top: 10px'>The data is based on the NBA player statistics from the regular season. Choose a player of interest and a type of shot you are interested in, and see the player's shooting trends over time. Enjoy!</div>")
  })
})
